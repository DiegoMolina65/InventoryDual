...
class BusquedaRegularStrategy implements BusquedaStrategy {
  @override
  String get titulo => 'Búsqueda Regular';
  ...
  Future<void> buscarProductos({
    ...
    try {
      ...
      final productosModel = await repository.buscarProductosPorAlmacen(
